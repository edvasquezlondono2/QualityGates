...
model.saveqg = (req,NOMBREPROYECTO,QG_CRITERIOS,QG_ENDPOINTS,QG_ERRORES,QG_CODESMELLS,QG_VULNERABILIDADES,QG_RADIOCAPAS,QG_RADIOSOPORTE,QG_COBERTURA,QG_COD_DUPLICADO,QG_TIME,QG_RADIOMETODOS,QG_RADIOPORT,QG_RADIOSQL) => {
  const ID = req.body.ID;
   req.getConnection((err,conn)=>{
  var querybuilder = 'insert into qualitygatescalc (ID,NOMBREPROYECTO,QG_CRITERIOS,QG_ENDPOINTS,QG_ERRORES,QG_CODESMELLS,QG_VULNERABILIDADES,QG_RADIOCAPAS,QG_RADIOSOPORTE,QG_COBERTURA,QG_COD_DUPLICADO,QG_TIME,QG_RADIOMETODOS,QG_RADIOPORT,QG_RADIOSQL) values (?,"'+NOMBREPROYECTO+'",'+QG_CRITERIOS+','+QG_ENDPOINTS+','+QG_ERRORES+','+QG_CODESMELLS+','+QG_VULNERABILIDADES+','+QG_RADIOCAPAS+','+QG_RADIOSOPORTE+','+QG_COBERTURA+','+QG_COD_DUPLICADO+','+QG_TIME+','+QG_RADIOMETODOS+','+QG_RADIOPORT+','+QG_RADIOSQL+');'
  console.log(querybuilder);
  console.log(ID,NOMBREPROYECTO,QG_CRITERIOS,QG_ENDPOINTS,QG_ERRORES,QG_CODESMELLS,QG_VULNERABILIDADES,QG_RADIOCAPAS,QG_RADIOSOPORTE,QG_COBERTURA,QG_COD_DUPLICADO,QG_TIME,QG_RADIOMETODOS,QG_RADIOPORT,QG_RADIOSQL)
